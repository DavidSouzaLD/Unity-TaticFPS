...
public class PlayerCamera : StaticInstance<PlayerCamera>
{
    [Header("Camera")]
    ...
    public static Camera GetCamera => Instance.Camera;
    public static Vector3 WorldToScreen(Vector3 _position) => Instance.Camera.WorldToScreenPoint(_position);
    public static bool GetLockState() => isCursorLocked;
