...
public class Weapon : WeaponBase
{
    ...
    {
        bool canFire = !PlayerController.GetStates.GetState("Running") && PlayerCamera.isCursorLocked && !isReloading;
    ...
    {
        bool canReload = InputManager.Reload && !PlayerController.GetStates.GetState("Running") && PlayerCamera.isCursorLocked && extraBullets > 0 && currentBullets < bulletsPerMagazine && !isReloading;
    ...
    {
        bool canAim = InputManager.Aim && !PlayerController.GetStates.GetState("Running") && PlayerCamera.isCursorLocked && !isReloading;
